...
`docs/../README.md § dashboard` describes the report; the definition is generated by a script
(kept in the session scratchpad, to be checked in) with the rules that matter:
