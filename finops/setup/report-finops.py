...
schema={"type":"object","properties":{
 ...
 "totalUsd":{"type":"number","title":"Costo total (USD)"},"appsUsd":{"type":"number","title":"Atribuido a aplicaciones (USD)"},"sharedUsd":{"type":"number","title":"Plataforma compartida (USD)"},"unallocatedUsd":{"type":"number","title":"Sin atribuir (USD)"},"attributedPct":{"type":"number","title":"% atribuido a apps"},
...
ui={"type":"VerticalLayout","elements":[
 ...
 {"type":"HorizontalLayout","options":{"columns":[2.4,2.4,2.4,2.4,2.4]},"elements":[kpi("totalUsd"),kpi("appsUsd"),kpi("sharedUsd"),kpi("unallocatedUsd"),
