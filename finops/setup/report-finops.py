...
ap = argparse.ArgumentParser(); ap.add_argument('--spec-id', required=True, help='uuid of the cost_daily spec in the organization'); ap.add_argument('--out', default='np-report-finops.json')
ARGS = ap.parse_args()
